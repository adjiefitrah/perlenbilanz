<div id="uebersicht">
	...
	<form>
	<div>
		<div style="float: left; text-align: left; width: 300px; margin-right: -300px; height: 120px;">
			<h2>Aktueller Monat</h2>
			<table style="width: 300px;" class="overview">
				<tr>
					<th></th>
					<th>Brutto</th>
			...
			<br/>
			<h2>Notizen</h2>
			<div style="width: 285px; height: 300px;">
