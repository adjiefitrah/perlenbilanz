...
namespace OCA\Perlenbilanz\AppFramework\Middleware\Security;
...
use OCA\Perlenbilanz\AppFramework\Http\RedirectResponse;
use OCA\Perlenbilanz\AppFramework\Utility\MethodAnnotationReader;
use OCA\Perlenbilanz\AppFramework\Middleware\Middleware;
