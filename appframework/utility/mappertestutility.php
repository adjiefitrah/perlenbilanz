...
namespace OCA\Perlenbilanz\AppFramework\Utility;
...
abstract class MapperTestUtility extends TestUtility {
	 ...
	 * @param \OCA\Perlenbilanz\AppFramework\Core\API $api the api mock
	 */
	protected function beforeEach(){
		$this->api = $this->getMock('\OCA\Perlenbilanz\AppFramework\Core\API',
